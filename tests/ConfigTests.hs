...
test_errors = do
  ...
  assertError "old cabal" "field \"cabal-version\": the tool supports only cabal 3.12 and later" "cabal-version: '3.10'\n"
  ...
  assertError "old cabal full" "field \"cabal-version\": the tool supports only cabal 3.12 and later" "cabal-version: 3.10.3.0\n"
