...
The generated file starts with this comment. If the user gave `--config`,
the command line in the comment contains it, also with the default path.
The command line also contains each other option that is not a default.
